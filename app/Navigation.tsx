...
const Navigation = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full lg:w-60 xl:w-80 lg:h-full border-b lg:border-r lg:border-b-0 flex justify-center z-50 overflow-hidden flex-col'>
      {/* toggle button */}
      <button
        className={
          'p-2 hover:bg-white bg-gray-50 transition flex justify-center z-20 lg:hidden'
        }
